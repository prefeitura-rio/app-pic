...
const Row = (props: {
  ...
  return (
    ...
    >
      <div style={{ flex: '2.5 1 0%', minWidth: 160 }} className="px-2 font-medium">
        <span className="line-clamp-2">{participant.nome || "-"}</span>
      </div>
      <div style={{ flex: '1 1 0%', minWidth: 110 }} className="px-2 font-mono">
        {participant.cpf || "-"}
      </div>
      <div style={{ flex: '0.8 1 0%', minWidth: 80 }} className="px-2">
      ...
      <div style={{ flex: '0.5 1 0%', minWidth: 60 }} className="px-2">
        {participant.idade != null ? `${participant.idade} anos` : "-"}
      </div>
      <div style={{ flex: '0.5 1 0%', minWidth: 60 }} className="px-2 text-center capitalize">
        {participant.status || "-"}
      </div>
      <div style={{ flex: '0.4 1 0%', minWidth: 50 }} className={`px-2 text-center font-mono ${getTotalColor(participant.total_fracao)}`}>
        {participant.total_fracao || "-"}
      </div>
      <div style={{ flex: '0.5 1 0%', minWidth: 55 }} className="px-2 text-center font-mono">
        {participant.assistencia_fracao || "-"}
      </div>
      <div style={{ flex: '0.5 1 0%', minWidth: 55 }} className="px-2 text-center font-mono">
        {participant.educacao_fracao || "-"}
      </div>
      <div style={{ flex: '0.4 1 0%', minWidth: 50 }} className="px-2 text-center font-mono">
        {participant.saude_fracao || "-"}
      </div>
      <div style={{ flex: '0.8 1 0%', minWidth: 80 }} className="px-2 text-center">
        <Badge variant={getBadgeVariant(participant.situacao)} className="text-xs h-5 px-1.5">
  ...
  return (
    <div className="rounded-lg border overflow-hidden h-[700px] bg-card flex flex-col relative">
      ...
      >
        ...
        >
          <div style={{ flex: '2.5 1 0%', minWidth: 160 }} className="px-2">Nome</div>
          <div style={{ flex: '1 1 0%', minWidth: 110 }} className="px-2">CPF</div>
          <div style={{ flex: '0.8 1 0%', minWidth: 80 }} className="px-2">Grupo</div>
          <div style={{ flex: '1 1 0%', minWidth: 100 }} className="px-2">Bairro</div>
          <div style={{ flex: '0.5 1 0%', minWidth: 60 }} className="px-2">Idade</div>
          <div style={{ flex: '0.5 1 0%', minWidth: 60 }} className="px-2 text-center">Status</div>
          <div style={{ flex: '0.4 1 0%', minWidth: 50 }} className="px-2 text-center">Total</div>
          <div style={{ flex: '0.5 1 0%', minWidth: 55 }} className="px-2 text-center">Assist.</div>
          <div style={{ flex: '0.5 1 0%', minWidth: 55 }} className="px-2 text-center">Educ.</div>
          <div style={{ flex: '0.4 1 0%', minWidth: 50 }} className="px-2 text-center">Saúde</div>
          <div style={{ flex: '0.8 1 0%', minWidth: 80 }} className="px-2 text-center">Situação</div>
        </div>
      </div>
