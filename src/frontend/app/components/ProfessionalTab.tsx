...
import { bairros, unidadesPorBairro, coordenadoriasCAP, coordenadoriasCRE, coordenadoriasCRAS } from "../utils/constants";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Select value={selectedClinica} onValueChange={setSelectedClinica}>
              ...
              <SelectContent>
                ...
                {clinicas.map((c, index) => (
                  <SelectItem key={`${c}-${index}`} value={c}>{c}</SelectItem>
                ))}
              </SelectContent>
            </Select>
            ...
            <Select value={selectedCRASUnidade} onValueChange={setSelectedCRASUnidade}>
              ...
              <SelectContent>
                ...
                {crasUnidades.map((cr, index) => (
                  <SelectItem key={`${cr}-${index}`} value={cr}>{cr}</SelectItem>
                ))}
              </SelectContent>
            </Select>
          </div>
